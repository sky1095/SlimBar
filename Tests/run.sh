...
PY
source ./sparkle.sh
xcrun swiftc -swift-version 5 -module-cache-path "$PWD/build/module-cache" build/menu-test/main.swift Sources/Features.swift Sources/StatusPresentation.swift Sources/Updates.swift -o build/menu-test/check \
